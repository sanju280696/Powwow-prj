...
public class PushNotifictionHelperForMultiple extends AsyncTask<String, Void, String> {
    ...
    public static String TAG = com.desire.powwow.Notifications.PushNotifictionHelper.class.getName();
    ...
    protected String doInBackground(String... strings) {
        ...
        try {
            ...
            Log.d(TAG, "doInBackground: " + fcmId + "::" + msg + "::" + msg);
            try {
                json.put("to", fcmId);
            ...
            try {
                info.put("title", msg); // Notification title

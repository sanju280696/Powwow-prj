...
import com.desire.powwow.DiscussionSubmit;
...
public class NewsMainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    private static final String NEWS_API_URL =
            "https://content.guardianapis.com/search?api-key=fee0f3e8-9312-4b15-bff0-b3070fad238e";
    // "http://content.guardianapis.com/search?q=android,iOS,startup,recent&show-tags=contributor&api-key=test";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Utils.checkConnection(NewsMainActivity.this)) {
            // Not Available...
